...
root = tk.Tk()
root.title("Instagram Profile Details")
...
def search():
        ...
        if details.get(1.0,END) != "":
                ...
                Button(innerframe1,text="click to see",relief=RAISED,borderwidth=2,font=('verdana',8,'bold'),bg='#f05742',fg="white",command=pic).place(x=180,y=145)
...
frame = Frame(root,width=400,height=300,relief=RIDGE,borderwidth=5,bg='#f05742')
frame.place(x=0,y=0)

innerframe = LabelFrame(frame,width=380,height=50,relief=RIDGE,borderwidth=3,bg='#f05742',highlightbackground="white", highlightcolor="white", highlightthickness=2)
...
search = Button(frame,text="Search",relief=RAISED,borderwidth=2,font=('verdana',8,'bold'),bg='#f05742',fg="white",command=search)
search.place(x=270,y=15)


innerframe = LabelFrame(frame,width=380,height=240,relief=RIDGE,borderwidth=3,bg='#f05742',highlightbackground="white", highlightcolor="white", highlightthickness=2)
innerframe.place(x=5,y=45)


innerframe1 = LabelFrame(innerframe,text="Profile Details",width=370,height=230,highlightbackground="white", highlightcolor="white", highlightthickness=5,font=('verdana',10,'bold'))
